...
s = surface!(ax,xs9,ys9,   color= σ9₁₁, colormap=:haline,colorrange = (-3000000,1000000))
s = surface!(ax,xs10,ys10, color=σ10₁₁, colormap=:haline,colorrange = (-3000000,1000000))
s = surface!(ax,xs11,ys11, color=σ11₁₁, colormap=:haline,colorrange = (-3000000,1000000))
...
save("./png/slit damper_hr_M11.png",fig)
