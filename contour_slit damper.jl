...
s = surface!(ax,xs1,ys1,   color=  σ₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs2,ys2,   color= σ2₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs3,ys3,   color= σ3₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs4,ys4,   color= σ4₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs5,ys5,   color= σ5₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs6,ys6,   color= σ6₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs7,ys7,   color= σ7₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs8,ys8,   color= σ8₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs9,ys9,   color= σ9₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs10,ys10, color=σ10₂₂, colormap=:haline,colorrange = (-400000,400000))
s = surface!(ax,xs11,ys11, color=σ11₂₂, colormap=:haline,colorrange = (-400000,400000))
