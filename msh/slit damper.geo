...
Transfinite Curve{1,7} = 100;
Transfinite Curve{2,6,8,12} = 10;
Transfinite Curve{10,22,24,32,34,4} = 50;
Transfinite Curve{9,5,11,3} = 10;
Transfinite Curve{23,33,21,31} = 40;
